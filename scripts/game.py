...
class Game:
   ...
   # Create all of the disconnected rooms
	...
	rooms = {
		...
		"Armoury": Room("Armoury", "./assets/Armoury.png", enemy=Enemy("Gatekeeper", 10, 2, None, None, None, "./assets/Gatekeeper.png")),
		...
		"Watch Tower": Room("Watch Tower", "./assets/Watchtower.png", items=[Weapon(player.status, "Hand Axe", 2)]),
