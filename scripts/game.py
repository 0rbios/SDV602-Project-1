...
class Game:
	...
	def __init__(self):
		...
		Enemy("Gatekeeper",
                	...
                	None,
               	self.sen_elements[2],
                	"./assets/Gatekeeper.png",
                 	"Gatekeeper: Halt! You have been banished from this place! I will not hesitate to force you out!",
                  "Gatekeeper: Stay... Away... From... Master...",
                  [key for key in self.keys if key.name =="Living Quarters' Key"]
                  ),
		Enemy("Archer",
        				21,
            		2, 
                	...
                	None, 
                 	self.sen_elements[3],
                  "./assets/Archer.png",
                  "Archer: How did you get in here, traitor!",
                  "Archer: The master will not stand for this!",
                  [key for key in self.keys if key.name =="Dining Hall Key"]
                  ),
		Enemy("Chef",
        				24,
            		4,
                  ...
                  "Chef: I should have poisoned you when I had the chance.",
                  [key for key in self.keys if key.name =="Dining Hall Exit Key"]
                  ),
		Enemy("Initiate",
        				28,
            		2,
                	...
                	None,
                 	self.sen_elements[1],
                  "./assets/Initiate.png",
                  "Initiate: I may be weaker than you. But I won't let you hurt the master!", 
                  "Initiate: Please no! Don't hurt him!", 
                  [key for key in self.keys if key.name =="Aviary Key"]
                  ),
		Enemy("Underling",
        				32,
            		4,
                	...
                	None,
               	self.sen_elements[4],
                	"./assets/Underling.png",
                 	"Mad One's Underling: The master has more worth in his finger than you have in your entire body! There's no way you'll stop him!",
                  "Mad One's Underling: S-Stay away from the master!", 
                  [key for key in self.keys if key.name =="Vault Key"]
                  ),
		Enemy("The Mad One",
        				45,
            		8,
